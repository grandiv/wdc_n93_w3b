...
function Alam() {
  return (
    <div className="relative flex items-start aspect-[360/1600] flex-col overflow-hidden pt-[10vh]">
      {/* Text Box */}
      <div className="hidden w-[20vw] h-[40vh] relative flex-col">
        <Image
      ...
      {/* Tulisan 3D */}
      <div className="relative h-[20vh] bottom-[155vh] w-[100vw]">
        <Image
      ...
      <div className="relative flex bottom-[170vh] h-[40vh] w-[130vw]">
        <Image
      ...
      {/* Efek Bagian Alam */}
      <div className="relative bottom-[200vh] bg-[red] h-[25vh] left-[25vw] z-0 top-[66vh] w-[50vw]">
        <Image
      ...
      {/* Deskripsi Budaya*/}
      <div className="relative flex bottom-[155vh] skew-y-[30deg] z-30 h-[7vh] left-[39vw] w-[60vw]">
      ...
      {/* Deskripsi Alam */}
      <div className="relative flex z-30 h-[7vh] w-[50vw] bottom-[102vh] skew-y-[30deg] left-[50vw]">
        <p className="text-[2.2vw] text-center">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
          veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
